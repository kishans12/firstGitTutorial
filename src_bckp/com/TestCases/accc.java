...
public class accc extends BSOrderXL
{
	  int i,j,rc,c;
...
////////////				///call capturetotal
							...
							OT.selectByVisibleText("Super Multiple");
							log.log(LogStatus.INFO, "Select Order type : Super Multiple");
							    	...
							    	for (int row1 = 2; row1 < rows_count;row1++) 
							    	{
							    	    ...
							    	    for (column = 1; column < columns_count;)//column++) 
							    	    {
							    	        ...
							    	        if(scrip.contains(vr.scrip1))
							    	        {
							        	        ...
							        	        {
								    	            if(scrip.contains("Super Multiple"))
									    	        {
								    	            	System.out.println("supermultiple");
								    	            	ele.click();

...
public class TC4PLFNOvitdel extends beforesuitedealer
	{	
		...
		public static String ME,capME,capqty;
				  ...
				  Row row = vr.s.getRow(i);	
						  ...
						  {										  
							...
							///select action							  
							  ...
							  ///enter qty
							  j=j+1;
							  capqty = w.findElement(By.id("1400")).getText();//(int) vr.s.getRow(i).getCell(j).getNumericCellValue();
...
//////////////////////////////////////////////////////////////////////////////////
							  ...
							  else if(ordermrk.equals("Super Multiple Plus"))
							  {
								  if(vr.roundoff!=0)
								  {
									  ...
									  j=j+1;
									  float SLOprice = (float) vr.s.getRow(i).getCell(j).getNumericCellValue();

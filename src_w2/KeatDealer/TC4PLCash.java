...
public class TC4PLCash extends beforesuitedealer
	{	
...
///////////////////////////////
			...
			//w.executeScript("scroll(0,-250)");
			/*WebElement wltable1 = w.findElement(By.id("65280")).findElement(By.id("1000"));
			WebElement b1 = wltable1.findElement(By.className("ScrollBar"));
			Map<String, Object> scrollInfo = new HashMap<String, Object>();
			scrollInfo.put("vertical", "smallIncrement");
			scrollInfo.put("count", 3);
			//w.executeScript("automation: ScrollPattern.Scroll", b1, scrollInfo);
			//w.executeScript("scroll(0,-250)");
			w.executeScript("input: ctrl_click", b1);
			Robot r = new Robot();
	        for(int i = 0; i < 5; i++)
	        {
...
///////////////////////////////			
							  ...
							  else if(ordermrk.equals("Margin Trading"))
							  {
								  ...
								  {		
									  for(int a=1;a<=1;a++) 
									  {
										  ...
										  w.findElement(By.id("1018")).sendKeys("1Y300");
										  w.findElement(By.id("1400")).sendKeys(String.valueOf("1"));
										  w.findElement(By.id("1014")).click();
										  w.findElement(By.name("Normal")).click();							
										  w.findElement(By.id("1342")).click();/////new buy order button
										  Thread.sleep(1500);
		...
		public void exit() throws Exception
		{
		 ...
		 {		  		  	
			  ...
			  ///report creation
			  report1 = new ExtentReports("D:\\testfile\\positionload.html");
			...
			public void nouse()
			  {
				  report1.endTest(log);
				  report1.flush();
				  //w.get("D:\\testfile\\positionload.html");				  
				  //w.get(srcfile);
			  }

...
import Main.beforesuitekeatpro;

public class TC1Randomchk extends beforesuitekeatpro
{	
	Robot robot;
	...
	public void openWL() throws Exception
	{
			...
			WebElement wltable = w.findElement(By.name("WatchList")).findElement(By.id("1012"));
		  ...
		  for(int i=m;i<=m+5;i++)
		  {
			  ...
			  if(flag.equals("Y"))
			  {
				  ...
				  {					  
							  ...
							  Thread.sleep(2000);
							  w.findElement(By.id("1017")).sendKeys(clientcode);							  
							  ...
							  w.findElement(By.id("1406")).sendKeys(enterscrip);
							  ...
							  w.findElement(By.id("1350")).sendKeys(String.valueOf(qty));
							  ...
							  {
								  ///enter amt
								  System.out.println("scrip equal "+scrip);
								  System.out.println("enterscrip equal "+enterscrip);
								  getprice = "0.0";
							  }							  
							  ...
							  w.findElement(By.id("1409")).sendKeys(String.valueOf(roundoff));
	...
	{		  		  
		  ...
		  limittable.findElement(By.id("1017")).sendKeys(clientcode);
	...
	public void tcrandomchk() throws Exception, IOException
	{
			...
			///report creation
			report1 = new ExtentReports("D:\\Windowapp\\randomchk.html");
	...
	public void nouse()
	  {
		  report1.endTest(log);
		  report1.flush();
		  //w.get("D:\\Windowapp\\randomchk.html");
		  //w.get(srcfile);
	  }

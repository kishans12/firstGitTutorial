...
public class TC5MockSMP extends beforesuitedealer
	{	
		...
		public void normsmmsg() throws Exception
		{
			  ...
			  {		
				  ...
				  {		  													  
						  ...
						  System.out.println("radio1 size "+radio1.size());
							...
							/*
							if(getordno[0] !=null &&  !getordno[0].isEmpty())
							{
		...
		{			
			...
			for(m=1;m<=rc3.size();m++)
			{
				...
				if(capordno.equals(storesmordno) && getstat.equals("TRAD"))
				{
					...
					log.log(LogStatus.INFO, "Super Multiple Plus Order No " +capordno+ " is "+getstat);
					break;
				}
					  ...
					  {		
						  ...
						  for(int k=1;k<=rc1.size();k++)
						  {
							  ...
							  {	
								  ...
								  {	
									  log = report1.startTest("Place Super Multiple Plus Order for :"+vr.forreportscripname);
									  log.log(LogStatus.INFO, "Scrip " +vr.scrip+ " is selected");
									  SuperMultiple();
								  }								  
								  break;

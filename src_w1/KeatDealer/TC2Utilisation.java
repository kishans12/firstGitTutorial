					  ...
					  {				
						  ...
						  for(int k=1;k<=rc1.size();k++)
						  {
							  ...
							  {								  
								  ...
								  {
									  vr.roundoff=0.0;
									  ///calculate reqd margin for currency
									  ...
									  {		///calculate reqd margin for cash and fno
								  ...
								  {		
									  ...
									  for(int z=1;z<=colcount1.size();z++)
									  {		  													  
								  ...
								  if(capordno.equals(getordno[0]) && getstat.equals("OPN") || getstat.equals("AMO"))
								  {
									  ...
									  for(int a=1;a<rc2.size();a++)
									  {
										  ...
										  if(vr.scrip.equals(placecaputilscrip) && ME.equals(getme))
										  {
											  ...
											  if(vr.modmatchround == vr.roundoff1)
											  {
												///open limits
												  Thread.sleep(500);
												  robot.keyPress(KeyEvent.VK_SHIFT);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////									  
		 ...
		 {		  		  	
			  ...
			  ///report creation
			  report1 = new ExtentReports("D:\\Windowapp\\winapputilisation11.html");

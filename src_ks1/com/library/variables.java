...
public class variables extends BSOrderXL
{
	...
	public static int ordertype = flag+1;
	public static int scrips=ordertype+1;
	public static int ME=scrips+1;
	public static int IT=ME+1;
	public static int scpname=IT+1;
	public static int scripval=scpname+1;
	public static int EC=scripval+1;
	public static int actn=EC+1;
	public static int qty=actn+1;
	public static int mul=qty+1;
	public static int pr=mul+1;
	public static int actpr=pr+1;
	public static int modpr=actpr+1;
	public static int slotrigpr=modpr+1;
	public static int ordno=slotrigpr+1;
	public static int slono=ordno+1;
	public static int modiqty=slono+1;
	public static int sqoffordno=modiqty+1;
	public static int cat=sqoffordno+1;
	public static int diffbetnl2l99=cat+1;

...
public class TC5SMLTP extends BSOrderXL
{
	  ...
	  public double chngestrngpr,no;
	  public static String status,highprice,lowprice,formatted,formatted1,scrip,getscrip,qty;
	  ...
	  com.library.variables vr = new com.library.variables();
		...
		{			
			...
			vr.fixmultiple = (float) vr.s.getRow(i).getCell(10).getNumericCellValue();  	
			System.out.println("multiple " +vr.fixmultiple);
			
			DecimalFormat format1 = new DecimalFormat("0.00");
	        formatted1 = format1.format(vr.fixmultiple);
				 	    ...
				 	    {					 	    	//tr[@class ='tinside']
							...
							if(arr[i].startsWith(vr.scrip1))
							{
								if(vr.forreportscripname.equals("Currency"))
								{
									...
									{
										vr.cap = 0.0;
										System.out.println("diff multiple ");
									}
	  ...
	  public void PlaceSMorder() throws Exception
	  {
			...
			///report creation
			report1 = new ExtentReports("D:\\Saleema\\supermultiple.html");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							String arrow = ">>";
							WebElement mytable1 = w.findElement(By.xpath("//*[@id='tabbed_area']/td/ul"));
							//To locate rows of table. 
							List < WebElement > rows_table1 = mytable1.findElements(By.tagName("li"));
							//To calculate no of rows In table.
							int rows_count1 = rows_table1.size();
							System.out.println("row count "+rows_count1);
							if(rows_count1>1)
							{
								...
								for (int row1 = 0; row1 < rows_count1;row1++) 
								{
									...
									String scrip = rows_table1.get(row1).getText();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
								...
								if(vr.action.equals("BUY")||vr.action.equals("Buy"))
								{
							...
							{	///////////for FNO
								...
								perc = (float) vr.s.getRow(i).getCell(j).getNumericCellValue();
								vr.pr1 = w.findElement(By.id("stk_price")).getAttribute("value");
								System.out.println("capture LTP "+vr.pr1);
								w.findElement(By.id("stk_price")).clear();
								vr.price = (Double.parseDouble(vr.pr1)*perc)/100;
								chngestrngpr = Double.parseDouble(vr.pr1);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////								
							...
							{
								j=j+1;
								vr.RM = ((vr.quantity * chngestrngpr ) / vr.multiple);
										...
										{////////////////////////////////////////////////////////////////////////////
											if(vr.forreportscripname.equals("Currency"))
											{
												if(arr1[x].equals(formatted1))
												{
													...
													if(vr.forreportscripname.equals("Currency"))
													{
														log.log(LogStatus.INFO, "Margin Utilised " +match);
														vr.rw = vr.s.getRow(i);
														vr.cell = vr.rw.createCell(variables.smmarutil);
														vr.cell.setCellValue(match);
														
														vr.rw = vr.s.getRow(i);
														vr.cell = vr.rw.createCell(variables.smmutil);
														vr.cell.setCellValue(total);
													}
													else
													{
													...
													if(vr.matchround.equals(vr.reqmargin)||match.equals(total))
													{
														///click on cancel
														w.findElement(By.partialLinkText("CANCEL")).click();
											...
											else
											{
												...
												{
													log.log(LogStatus.INFO, "Margin utilised didnt got calculated. ");
												}
											}
										////////////////////////////////////////////////////////////////////////////////////////
										}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								///to chk low trigger price message for nse and derivative
								if(vr.forreportscripname.equals("NSE") || vr.forreportscripname.equals("NSE-Derivatives"))
								{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								...
								w.findElement(By.partialLinkText("CHANGE ORDER")).click();////////from here
								String sloerr = "Error";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								//check for SLO trigger price for currency
								if(vr.forreportscripname.equals("Currency"))
								{
									///calc SLO trig price
									SLOprice = (float) vr.s.getRow(i).getCell(14).getNumericCellValue();
									Double SLOcalc = (chngestrngpr * SLOprice)/100;
									//Double sloroundoff = (Math.round(SLOcalc*100.0)/100.0);											
									//System.out.println("slo calc "+sloroundoff);
									Double SLOfinalcalc;
									if(vr.action.equals("BUY") || vr.action.equals("Buy"))
									{
										SLOfinalcalc = chngestrngpr - SLOcalc;
									}
									else
									{
										SLOfinalcalc = chngestrngpr + SLOcalc;
									...
									double copyslo = SLOfinalcalc;//67.289435;//67.585375;			
									
									String cnvtdbl2strng = String.valueOf(copyslo);
									System.out.println("number ..... "+cnvtdbl2strng);
									
									String[] splitter = cnvtdbl2strng.toString().split("\\.",0);			
									splitter[1].length();   // After  Decimal Count	
									System.out.println("split 0 "+splitter[1]);
									System.out.println("split 1 "+splitter[1].length());
									int xyz = splitter[1].length();
									if(xyz==3)
									{
										no = copyslo*10;
									}
									...
									Double no1 = (Math.round(no*100.0)/100.0);			
									System.out.println("no "+no1);
									String number1 = String.valueOf(no1);
									
									DecimalFormat format1 = new DecimalFormat("0.00");
									String formatted1 = format1.format(copyslo);
									System.out.println("form....." +formatted1);
									
									number1 = number1.substring(number1.indexOf(".")).substring(1);
									System.out.println("number1 "+number1);					
									
									int abc = Integer.parseInt(number1);
									
									if(abc>0 && abc<=25)
									{
										val = "25";									
									}
									else if(abc>=26 && abc<=50)
									{
										val = "50";
									}
									else if(abc>=51 && abc<=75)
									{
										val = "75";
									}
									else if(abc>=76 && abc<=100 || abc==00)
									{
										val = "00";
									}
									String con;
									con = formatted1.concat(val);
									System.out.println("con "+con);
									
									System.out.println("calc slo trig price "+con);
									String SLOcaptrigpr = w.findElement(By.id("stk_t_price")).getAttribute("value");
									System.out.println("cap slo trigger price "+SLOcaptrigpr);
									if(con.equals(SLOcaptrigpr))
									{
										log.log(LogStatus.INFO, "SLO Trigger price " +SLOcaptrigpr+ " is equal to calculated trigger price "+con);																		
									}
									else
									{
										log.log(LogStatus.ERROR, "SLO Trigger price " +SLOcaptrigpr+ " is not equal to calculated trigger price "+con);																		
									}
									
									///write act slo trig price to excel
									vr.rw = vr.s.getRow(i);
									vr.cell = vr.rw.createCell(15);
									vr.cell.setCellValue(SLOcaptrigpr);
									
									///write calc slo trig price to excel
									vr.rw = vr.s.getRow(i);
									vr.cell = vr.rw.createCell(16);
									vr.cell.setCellValue(con);									
								}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
							Actions act31 = new Actions(w);
							act31.moveToElement(w.findElement(By.linkText("Reports"))).click().perform();	
							WebElement Sublink31 = w.findElement(By.linkText("Order Status"));
							Sublink31.click();
							
							String statustrad = w.findElement(By.xpath("//td[text()='"+vr.stckno+"']/following-sibling::td[6]")).getText();
							System.out.println("statustrad "+statustrad);
							if(statustrad.equals("TRAD"))
							{								
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////								
								...
								{
									log.log(LogStatus.INFO, "Square off order " +caporderno+ " , is OPN ");									
								}
							  }
							}
							else
							{
								log.log(LogStatus.INFO, "Supermultiple Buy order " +vr.stckno+ " is " +statustrad+ " , so cannot place square off order ");									
							}
				////////////////////////////			
						 }							
							break;		  						  			
		...
		public void nouse()
		  {
			  report1.endTest(log);
			  report1.flush();
			  w.get("D:\\Saleema\\supermultiple.html");
			  w.get(vr.srcfile);
		  }

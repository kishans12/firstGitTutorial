...
import Main.BSOrderXLIE;
import Utilisation.ManageWatchlist;

public class TC1UtilisationIE extends BSOrderXLIE
{
	...
	{	
		...
		WebElement we = w.findElement(By.linkText("Watchlist"));
		...
		//WebElement mainMenu = w.findElement(By.linkText("Watchlist"));
		//action.moveToElement(mainMenu).moveToElement(w.findElement(By.xpath("//*[@id='sub_mnu1']/div/ul/li[15]/a"))).click().build().perform();
				 
		///click funds >>equity/derivatives
		Actions act = new Actions(w);
		act.moveToElement(w.findElement(By.xpath("//*[@id='mnu1']/a"))).perform();
		w.findElement(By.xpath("//*[@id='sub_mnu1']/div/ul/li[15]/a")).click();
		//WebDriverWait wait2 = new WebDriverWait(w, 10);
		//wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='sub_mnu1']/div/ul/li[15]/a")));
		//w.findElement(By.linkText("Manage")).click();
		//act.click(w.findElement(By.xpath("//*[@id='sub_mnu1']/div/ul/li[15]/a")));
		//act.click();
		//WebElement Sublink = w.findElement(By.xpath("//*[@id='sub_mnu1']/div/ul/li[15]/a"));
		//Sublink.click();
		*/
	...
	public void nouse()
	  {
		  report1.endTest(log);
		  report1.flush();
		  w.get("D:\\Saleema\\utilisation.html");
		  w.get(srcfile);
	  }
}

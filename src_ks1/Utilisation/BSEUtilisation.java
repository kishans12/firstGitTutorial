...
public class BSEUtilisation extends BSOrderXL
{
	...
	public void PlaceAMOBuyOrder() throws Exception 
	  {
		...
		///report creation
		//report1 = new ExtentReports("D:\\Saleema\\BSEUtilisation.html");
		...
		////call login function
	  	...
	  	log = report1.startTest("Place Cash Order BSE");
		...
		///chk for AMO
		String amochk = s.getRow(8).getCell(2).getStringCellValue();
	...
	public void ManageCashAMO() throws Exception 
	  {		
		///report creation
		log = report1.startTest("Change Cash Order BSE");
	 ...
	 @Test(priority = 2)
	  ...
	  {
		 ///for report name
		  log = report1.startTest("Cancel Cash Order BSE");
	...
	public void nouse()
	  {
		 //report1.endTest(log);
		 //report1.flush();
		 //w.get("D:\\Saleema\\BSEUtilisation.html");
	  }

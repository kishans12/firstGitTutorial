...
public class NSEUtilisation extends BSOrderXL
{
	...
	public void PlaceAMOBuyOrder() throws Exception 
	  {
		...
		////call login function
	  	...
	  	log = report1.startTest("Place Cash Order NSE");
		...
		///chk for AMO
		String amochk = s.getRow(8).getCell(1).getStringCellValue();
	...
	public void ManageCashAMO() throws Exception 
	  {		
		///report creation
		log = report1.startTest("Change Cash Order NSE");
	  	
		///to check for any error
		String amocheck = "Error";
	  	if(w.getPageSource().contains(amocheck))
	  	{
	  		capturemsg = w.findElement(By.xpath("//*[@id=\'container\']/div[1]/table/tbody/tr[2]/td/table/tbody/tr/td")).getText();
	 ...
	 @Test(priority = 2)
	  ...
	  {
		 ///for report name
		  log = report1.startTest("Cancel Cash Order NSE");

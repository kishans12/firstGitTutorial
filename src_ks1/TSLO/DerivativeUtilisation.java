...
public class DerivativeUtilisation extends BSOrderXL
{
	...
	public void PlaceAMOBuyOrder() throws Exception 
	  {
		...
		///report creation
		//report1 = new ExtentReports("D:\\Saleema\\TSLOBSEUtilisation.html");
		...
		////call login function
	  	...
	  	log = report1.startTest("Place TSLO Order Derivative");
		...
		if(tslochk.equals("YES"))
		{
			...
			///enter spread value
			int spread = (int) s.getRow(11).getCell(3).getNumericCellValue();
	...
	public void ManageCashAMO() throws Exception 
	  {		
		///report creation
		log = report1.startTest("Change TSLO Order Derivative");
	 ...
	 @Test(priority = 2)
	  ...
	  {
		 ///for report name
		  log = report1.startTest("Cancel TSLO Order Derivative");
	...
	public void nouse()
	  {
		  //report1.endTest(log);
		  //report1.flush();
		  //w.get("D:\\Saleema\\TSLOBSEUtilisation.html");
	  }
}
